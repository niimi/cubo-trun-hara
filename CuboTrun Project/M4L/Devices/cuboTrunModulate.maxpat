...
,
		"classnamespace" : "box",
		"rect" : [ 2540.0, 482.0, 1116.0, 785.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.0, 464.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 88.0, 88.0, 20.0 ],
					"text" : "id 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 150.0, 195.0, 85.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 48.0, 152.0, 67.0, 20.0 ],
									"text" : "downsamp~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 96.0, 80.0, 40.0, 20.0 ],
									"prototypename" : "Live",
									"triscale" : 0.75
								}
...
,
					"patching_rect" : [ 135.0, 525.0, 102.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Consolas",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 49.0, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 48.0, 90.0, 18.0 ],
					"text" : "out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 30.0, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 16.0, 90.0, 18.0 ],
					"text" : "in"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 810.0, 390.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 64.0, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 765.0, 390.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 64.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 720.0, 390.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 32.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 675.0, 390.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 405.0, 30.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 465.0, 102.0, 20.0 ],
					"text" : "scale 0. 1. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 458.0, 110.0, 66.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.0, 118.0, 64.0, 20.0 ],
					"text" : "universal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.0, 94.0, 71.0, 20.0 ],
					"text" : "js gettype"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 38.0, 55.0, 18.0 ],
					"text" : "Store ID"
				}
...
, 							{
						...
						"bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
						"editing_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ]
					}
,
					"patching_rect" : [ 330.0, 62.0, 105.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"editing_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
						...
						"fontsize" : 10.0,
						"globalpatchername" : "",
						"locked_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
						"tags" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 298.0, 14.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 120.0, 45.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 242.0, 14.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 120.0, 45.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
							"expression" : ""
...
,
					"patching_rect" : [ 242.0, 38.0, 81.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"editing_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 259.0, 61.0, 18.0 ],
					"text" : "Menu sync"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 163.0, 61.0, 18.0 ],
					"text" : "Menu sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 342.0, 70.0, 20.0 ],
					"text" : "prepend id"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.0, 198.0, 83.0, 18.0 ],
					"text" : "< Arg. = type"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 125.0, 32.0, 18.0 ],
					"text" : "Type"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 50.0, 77.0, 18.0 ],
					"text" : "Refresh list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 246.0, 56.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 150.0, 56.0, 32.0 ],
					"text" : "prepend iterate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 318.0, 80.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 96.0, 90.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 222.0, 80.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 56.0, 90.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.0, 318.0, 80.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 96.0, 90.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 234.0, 222.0, 80.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 56.0, 90.0, 20.0 ],
					"textcolor" : [ 0.42, 0.45, 0.53, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 250.0, 258.0, 24.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 80.0, 30.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 202.0, 162.0, 24.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 40.0, 30.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "arm", "trigger" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 318.0, 45.0, 20.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 338.0, 93.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 80.0, 78.0, 18.0 ],
					"text" : "Parameter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 282.0, 294.0, 191.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 222.0, 45.0, 20.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 242.0, 93.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 40.0, 78.0, 18.0 ],
					"text" : "Device"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 234.0, 198.0, 196.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "M4L.chooser.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 126.0, 80.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 16.0, 90.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.0, 66.0, 24.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 0.0, 30.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "arm", "trigger" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 186.0, 126.0, 80.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 16.0, 90.0, 20.0 ],
					"textcolor" : [ 0.42, 0.45, 0.53, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 126.0, 45.0, 20.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 146.0, 96.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 0.0, 81.0, 18.0 ],
					"text" : "Track"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 186.0, 102.0, 201.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "M4L.chooser.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 99.0, 74.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 510.0, 140.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 382.0, 151.0, 42.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 52.0, 110.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 71.0, 69.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 167.0, 61.0, 18.0 ],
					"text" : "Passout >"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 20.0, 127.0, 100.0, 32.0 ],
					"restore" : 					{
						"DeviceChooser" : [ 0 ],
						"ListDevices" : [ 0.0 ],
						"ListParams" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 15.0, 92.0, 18.0 ],
					"text" : "Signal [0. 1.]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 422.0, 63.0, 18.0 ],
					"text" : "Object ID"
				}
...
,
					"patching_rect" : [ 330.0, 405.0, 93.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"editing_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 394.0, 382.0, 31.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 382.0, 46.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 600.0, 18.0, 18.0 ],
					"prototypename" : "M4L.Arial10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 15.0, 18.0, 18.0 ],
					"prototypename" : "M4L.Arial10"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 291.5, 345.0, 274.5, 345.0, 274.5, 284.0, 291.5, 284.0 ],
					"source" : [ "obj-102", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 243.5, 249.0, 226.5, 249.0, 226.5, 188.0, 243.5, 188.0 ],
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 361.5, 274.5, 463.5, 274.5 ],
					"source" : [ "obj-112", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-118", 0 ],
					"midpoints" : [ 195.5, 153.0, 178.5, 153.0, 178.5, 92.0, 195.5, 92.0 ],
					"source" : [ "obj-115", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 316.833333333333314, 178.5, 420.5, 178.5 ],
					"source" : [ "obj-118", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 339.5, 369.0, 526.5, 369.0, 526.5, 52.0, 339.5, 52.0 ],
					"order" : 1,
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-6" : [ "inMax", "inMax", 0 ],
			"obj-7" : [ "outMax", "outMax", 0 ],
			"obj-8" : [ "outMin", "outMin", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [ 			{
				"name" : "M4L.chooser.js",
				"bootpath" : "~/Documents/Works/BnaKyotoHara/Source/cubo-trun-hara/CuboTrun Project/M4L/Devices",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
