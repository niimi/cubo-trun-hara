...
function quat(x, y, z, w, currentTime) {
    ...
    // if (lastAngleAxis == undefined) {
    //     lastAngleAxis = angleAxis;
    // }
    // var diff = diffAngleAxis(angleAxis, lastAngleAxis);
    // lastAngleAxis = angleAxis;
    var angles = quaternionToEuler(q, order);
...
function diffAngleAxis(a0, a1) {
    var x = a0.angle * a0.axis.x - a1.angle * a1.axis.x;
    var y = a0.angle * a0.axis.y - a1.angle * a1.axis.y;
    var z = a0.angle * a0.axis.z - a1.angle * a1.axis.z;
