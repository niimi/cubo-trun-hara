...
,
		"classnamespace" : "box",
		"rect" : [ 2412.0, 269.0, 1116.0, 785.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 64.0, 48.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 64.0, 48.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 32.0, 48.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 32.0, 48.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 120.0, 48.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 120.0, 48.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 96.0, 96.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 56.0, 96.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 80.0, 30.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 40.0, 30.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "arm", "trigger" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 16.0, 96.0, 20.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 0.0, 30.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "arm", "trigger" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 0.0, 48.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 382.0, 46.0, 18.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.0, 208.0, 67.0, 20.0 ],
									"saved_object_attributes" : 									{
										"_persistence" : 1,
										"normalized" : 0,
										"smoothing" : 0.0
...
,
					"patching_rect" : [ 135.0, 510.0, 191.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"editing_bgcolor" : [ 0.568627450980392, 0.552941176470588, 0.552941176470588, 1.0 ],
